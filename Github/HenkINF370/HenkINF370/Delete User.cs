...
{
    public partial class Delete_User : MetroFramework.Forms.MetroForm
    {
        public Delete_User()
        {
            InitializeComponent();
        ...
        {
            DialogResult r = MetroFramework.MetroMessageBox.Show(this, "Are you sure you want to Delete this User?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
            if (r == DialogResult.Yes)
            {
                SqlConnection sqlcon2 = new SqlConnection(Globals.ConnectionString);
                sqlcon2.Open();
                string cmd2 = "DELETE FROM Users WHERE UserID ='" + UserID.ToString() + "'";
                SqlCommand sqlcom2 = new SqlCommand(cmd2, sqlcon2);
