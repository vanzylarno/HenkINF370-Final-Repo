...
{
    public partial class Update_Menu_Item2 : MetroFramework.Forms.MetroForm
    {
        public Update_Menu_Item2()
        {
            InitializeComponent();
        }
        string Filelocation;
        ...
        int PizzaSizeID;
        int PizzaBaseID;
        private void Update_Menu_Item2_Load(object sender, EventArgs e)
        {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    sqlcon5.Open();
                    string cmd5 = "UPDATE Menu SET ItemName = @ItemName, Price = @Price, Description =@Description, Image =@Image, MenuItemTypeID = @MenuItemTypeID, DrinkSizeID =@DrinkSizeID, PizzaSizeID =@PizzaSizeID, PizzaBaseID =@PizzaBaseID WHERE MenuItemID ='" + Globals.SelectedMenuItemID.ToString() + "'";
                    ...
                    MetroFramework.MetroMessageBox.Show(this, "Menu Item Successfully Updated!", "Message", MessageBoxButtons.OK, MessageBoxIcon.None);
