...
namespace HenkINF370
{
    public partial class Add_User_Types : MetroFramework.Forms.MetroForm
    {
        ...
        {
            DialogResult d = MetroFramework.MetroMessageBox.Show(this, "Are you sure you want to Add this User Type", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
