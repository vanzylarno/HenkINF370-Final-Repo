...
{
    public partial class Add_Drink_Size : MetroFramework.Forms.MetroForm
    {
        public Add_Drink_Size()
        {
            InitializeComponent();
        }

        private void Add_Drink_Size_Load(object sender, EventArgs e)
        {
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    sqlcon.Open();
                    string cmd = "INSERT INTO DrinkSize(Description, Price) VALUES(@Description, @Price)";
