...
namespace HenkINF370
{
    public partial class Add_Title : MetroFramework.Forms.MetroForm
    {
        ...
        {
            DialogResult d = MetroFramework.MetroMessageBox.Show(this, "Are you sure you want to Create this Title?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
