...
{
    public partial class Update_Shift : MetroFramework.Forms.MetroForm
    {
        public Update_Shift()
        {
            InitializeComponent();
        ...
        private void Update_Shift_Load(object sender, EventArgs e)
        {
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                Update_Shift2 myform = new Update_Shift2();
                myform.ShowDialog();
            }
        }
        ...
        private void Update_Shift_Leave(object sender, EventArgs e)
        {
            listBox1.Items.Clear();
            SqlConnection sqlcon = new SqlConnection(Globals.ConnectionString);
            sqlcon.Open();
