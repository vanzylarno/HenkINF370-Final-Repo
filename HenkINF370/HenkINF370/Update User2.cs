...
{
    public partial class Update_User2 : MetroFramework.Forms.MetroForm
    {
        public Update_User2()
        {
            InitializeComponent();
        ...
        private void Update_User2_Load(object sender, EventArgs e)
        {
            //Pre-Load Data
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult r = MetroFramework.MetroMessageBox.Show(this, "Are you sure you want to Update this User?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
