...
{
    public partial class Delete_Menu_Item : MetroFramework.Forms.MetroForm

    {
        ...
        private void Delete_Menu_Item_Load(object sender, EventArgs e)
        {
        ...
        {
            DialogResult d = MetroFramework.MetroMessageBox.Show(this, "Are you sure you want to Delete this Menu Item?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
            if (d == DialogResult.Yes)
            {
                SqlConnection sqlcon2 = new SqlConnection(Globals.ConnectionString);
                sqlcon2.Open();
                string cmd2 = "DELETE FROM Menu WHERE MenuItemID ='" + id.ToString() + "'";
                SqlCommand sqlcom2 = new SqlCommand(cmd2, sqlcon2);
                sqlcom2.ExecuteNonQuery();
                sqlcon2.Close();

                MetroFramework.MetroMessageBox.Show(this, "The Menu Item was Deleted Successfully!", "Message", MessageBoxButtons.OK, MessageBoxIcon.None);
                listBox1.Items.Clear();
                SqlConnection sqlcon = new SqlConnection(Globals.ConnectionString);
                sqlcon.Open();
                string cmd = "SELECT Distinct ItemName FROM Menu";
