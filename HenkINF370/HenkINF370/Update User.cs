...
{
    public partial class Update_User : MetroFramework.Forms.MetroForm
    {
        public Update_User()
        {
            InitializeComponent();
        ...
        {
            DialogResult d = MetroFramework.MetroMessageBox.Show(this, "Are you sure you want to Update this User?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
            if(d == DialogResult.Yes)
            {
                Globals.UpdateUserID = UserID;
                Update_User2 myform = new Update_User2();
                myform.ShowDialog();
                this.Close();
                this.Dispose(true);
            }
