...
{
    public partial class Add_Pizza_Base : MetroFramework.Forms.MetroForm
    {
        public Add_Pizza_Base()
        {
            InitializeComponent();
        }

        private void Add_Pizza_Base_Load(object sender, EventArgs e)
        {
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    sqlcon.Open();
                    string cmd = "INSERT INTO PizzaBase(Description, Price) VALUES(@Description, @Price)";
